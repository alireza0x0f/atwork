...
def refCallBack_BMT1(data):
    ...
    for t in data.tasks:
        ...
        '''if taskObjectName == 'Small Grey Alu. Profile' or taskObjectName == 'Large Grey Alu. Profile' or taskObjectName == 'Axis' or taskObjectName == 'Bearing Box' :
            taskParity = 0
        if taskObjectSource == 'Workstation 13' :
            taskParity = 0'''
...
if __name__ == '__main__':
    ...
    '''TASK_LIST = [['Motor','Workstation 3','pick','',1],['Small Black Alu. Profile','Precision Platform','put','',1]]
    do_task()'''

    table_delay = 15.7 - 5.72 #7.465'
